...
export const ProjectSettingsMemberDefaults = observer(function ProjectSettingsMemberDefaults(
  ...
  return (
    <div className="my-6 flex flex-col gap-y-6">
      <DefaultSettingItem title={t("ui.project_lead")} description={t("project_settings.members.project_lead_description")}>
        {currentProjectDetails ? (
          <Controller
            control={control}
            name="project_lead"
      ...
      <DefaultSettingItem title="Default Assignee" description={t("project_settings.members.default_assignee_description")}>
        {currentProjectDetails ? (
          <Controller
            control={control}
