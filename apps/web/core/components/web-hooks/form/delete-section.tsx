      ...
      {({ open }) => (
        <div className="w-full">
          <Disclosure.Button as="button" type="button" className="flex w-full items-center justify-between py-4">
            <span className="text-16 tracking-tight">{t("workspace_settings.settings.webhooks.danger_zone")}</span>
            ...
            <Disclosure.Panel>
              <div className="flex flex-col gap-8">
                <span className="text-13 tracking-tight">
                  {t("workspace_settings.settings.webhooks.delete_description")}
                </span>
                <div>
                  <Button
                    variant="error-fill"
