...
// ui
// components
import { cn, renderFormattedPayloadDate, getMonthName } from "@plane/utils";
          ...
          if (issueDetails?.start_date) {
            ...
            if (diffInDays < 0) {
              setToast({
                ...
                title: t("toast.error"),
                message: t("toast.due_before_start"),
              });
              return;
            }
          }
  ...
  return (
    <>
      <div ref={dayTileRef} className="group relative flex h-full w-full flex-col">
        ...
        >
          {date.date.getDate() === 1 && getMonthName(date.date.getMonth(), true) + " "}
          {isToday ? (
