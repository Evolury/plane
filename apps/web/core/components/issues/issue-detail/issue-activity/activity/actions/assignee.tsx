...
export const IssueAssigneeActivity = observer(function IssueAssigneeActivity(props: TIssueAssigneeActivity) {
  ...
  return (
    ...
    >
      <>
        {activity.old_value === "" ? t("activity_log.added_assignee") : t("activity_log.removed_assignee")}
        <a
        ...
        {showIssue && (activity.old_value === "" ? t("activity_log.prep_in") : t("activity_log.prep_from"))}
