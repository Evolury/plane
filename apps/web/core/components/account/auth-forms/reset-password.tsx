...
export const ResetPasswordForm = observer(function ResetPasswordForm() {
  ...
  return (
    <FormContainer>
      <AuthFormHeader title="Reset password" description={t("ui.create_new_password")} />
      ...
      >
        ...
        <div className="space-y-1">
          ...
          <PasswordStrengthIndicator translateLabel={t} password={resetFormData.password} isFocused={isPasswordInputFocused} />
        </div>
        <div className="space-y-1">
