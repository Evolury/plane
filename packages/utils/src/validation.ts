...
export const validateCompanyName = (
  ...
  if (!COMPANY_NAME_REGEX.test(companyName)) {
    return msg(
      t,
      "validation.company_allowed",
      "Company name can only contain letters, numbers, spaces, hyphens, and underscores"
    );
  }
