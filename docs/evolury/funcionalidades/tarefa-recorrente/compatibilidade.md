...
| #   | Recurso existente                   | Tratamento                                                                                              | Verificação                                                                                            |
| --- | ----------------------------------- | ------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| 14  | Subtarefas                          | Copiadas: um nível, abertas, teto de 50; sem data por padrão, ou com vencimento relativo declarado (F7) | ✓ `[T]` test_subtasks_come_along_open_and_dateless · test_a_subtask_can_have_its_own_relative_due_date |
