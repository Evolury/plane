...
| [propriedade-personalizada](evolury/funcionalidades/propriedade-personalizada/manual.md) | Entregue na v1.13.0 — campos próprios por projeto, com filtro, agrupamento e ordenação (ADR 0011). Subagrupamento, agrupar como opt-in da definição e arrastar para mudar o valor na próxima release |
